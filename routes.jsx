...
import { CurrencyConverterPage } from "./pages/ClientPage/CurrencyConverterPage.jsx"; // Nueva página de conversión de divisas
...
export const routes = [
  ...
  { path: "/currency-converter", element: <ProtectedRoute element={<CurrencyConverterPage />} requiredRoles={["USER_ROLE", "ADMIN_ROLE"]} /> }, // Nueva ruta
];